...
export const siteConfig: SiteConfig = {
	title: "Mizuki",
	subtitle: "Share my life",
	siteURL: "https://glasscode.top/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-07-04", // 站点开始运行日期，用于站点统计组件计算运行天数
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/glasscodeNya/MizukiMod",
			external: true,
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/glasscodeNya",
		},
	],
};
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to GlassUI Website!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
		...
		link: "https://github.com/glasscodeNya/MizukiMod", // 关于链接
	},
};
